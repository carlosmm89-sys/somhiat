...
export default function WhatsAppButton() {
  const phone = "34647045359";
  const message = encodeURIComponent("Hola, me gustaría solicitar información sobre sus servicios de arquitectura técnica.");
  ...
  return (
    <a
      ...
      style={{
        ...
        animation: "fadeInUp 1s cubic-bezier(0.22, 1, 0.36, 1) 2s both",
      }}
      onMouseEnter={(e) => {
